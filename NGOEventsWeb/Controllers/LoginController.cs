...
namespace NGOEventsWeb.Controllers
{
    public class LoginController : ApiController
    {
        ...
        public IHttpActionResult Authenticate([FromBody] LoginRequest login)
        {
            ...
            if (login != null)
                isUsernamePasswordValid = UserVerified(loginrequest.UserID, loginrequest.Password);/*loginrequest.Password == user.Password ? true : false;*/
        ...
        {
            UserNGO user = db.UserNGOes.Find(username);
